...
function Navbar() {
  return (
    <div>
      <header className="p-5 bg-blue-700 text-white  flex gap-6 md:pl-16 lg:p-3 sticky top-0  ">
        ...
        <div className="navsection hidden md:block md:flex  md:flex-col md:h-10 md:w-30 md:gap-2 p-2 lg:flex-row lg:mt-6 lg:ml-20 xl:ml-48">
          <NavLink
            to="/courses"
